...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:42.5,regY:128.5,rotation:-1,x:36.6,y:47.7},0).wait(1).to({rotation:-2,x:36.5,y:47.8},0).wait(1).to({rotation:-3,x:36.3,y:47.9},0).wait(1).to({rotation:-4,x:36.1,y:48.1},0).wait(1).to({rotation:-5,x:35.8,y:48.2},0).wait(1).to({rotation:-6.1,x:35.7,y:48.3},0).wait(1).to({rotation:-7.2,x:35.4,y:48.5},0).wait(1).to({rotation:-8.3,x:35.2,y:48.6},0).wait(1).to({rotation:-9.5,x:34.9,y:48.8},0).wait(1).to({rotation:-10.7,x:34.7,y:49},0).wait(1).to({rotation:-11.9,x:34.5,y:49.1},0).wait(1).to({rotation:-13.2,x:34.2,y:49.3},0).wait(1).to({rotation:-14.5,x:33.9,y:49.5},0).wait(1).to({rotation:-15.9,x:33.6,y:49.7},0).wait(1).to({rotation:-17.4,x:33.3,y:49.9},0).wait(1).to({rotation:-19,x:33.1,y:50.1},0).wait(1).to({rotation:-20.6,x:32.7,y:50.3},0).wait(1).to({rotation:-22.3,x:32.4,y:50.5},0).wait(1));
